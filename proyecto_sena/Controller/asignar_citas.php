...
<head>
    ...
    <title>asignar Cita Médica</title>
    <link rel="stylesheet" href="../css/solicitud_Citas.css">
    <link rel="icon" href="logo.ico" >
</head>
<body>
    <?php include_once '../View/header_asignar_Citas.php'; ?>
    ...
    <p>Aquí podrás:</p>
    <ul>
        <li>asignar citas médicas</li>
        <p style='font=bold;'>acceder a la asignación de la cita médica. Selecciona el servicio, la fecha y la hora disponibles que mejor se adapten a tu agenda, del usuario para finalizar el proceso.</p>
    <div class="citas-img">
    ...
    <div class="container">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" id="lugar_de_atencion" name="lugar_De_Atencion" required>
            </div>
            ...
            <button type="submit" class="asignar" >asignar Cita</button>
        </form>
    </div>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $lugar_de_atencion = $_POST['lugar_De_Atencion'] ?? null;
    ...
    if ( !$fechaHoraDisponible && $doctorDisponible || $fechaHoraDisponible && $doctorDisponible) {
        ...
        if ($stmt->execute()) {
            $mensaje = "<span class='mensaje-exito'>cita agendada con éxito.</span>";
        } else {
            $mensaje = "<span class='mensaje-error'>Error al asignar la cita: " . implode(", ", $stmt->errorInfo()) . "</span>";
        }
        } else {
