...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    try {
        ...
        if ($stmt->rowCount() > 0) {
            header("Location: ../View/doctor.php?message=success_password");
        } else {
    ...
    <div id="loginContainer">
        <form action="" method="POST">
            <h2>Cambio de Contraseña</h2>
                ...
                <input type="password" class="form-control" id="floatingPassword" name="new_password" placeholder="Ingresa tu nueva contraseña" pattern="(?=.*\d)(?=.*[a-zA-Z]).{8,}" title="La contraseña debe tener al menos 8 caracteres y contener tanto letras como números."required>
